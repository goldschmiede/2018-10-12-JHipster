...
public class TagResourceIntTest {
     ...
     *
     * @see com.carlogistics.articles.repository.search.TagSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createTag() throws Exception {
        ...
        assertThat(testTag.getBeschreibung()).isEqualTo(DEFAULT_BESCHREIBUNG);
        assertThat(testTag.getTitel()).isEqualTo(DEFAULT_TITEL);
    ...
    public void updateTag() throws Exception {
        ...
        Tag testTag = tagList.get(tagList.size() - 1);
        assertThat(testTag.getBeschreibung()).isEqualTo(UPDATED_BESCHREIBUNG);
        assertThat(testTag.getTitel()).isEqualTo(UPDATED_TITEL);
