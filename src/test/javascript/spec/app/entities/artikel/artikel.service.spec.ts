...
describe('Service Tests', () => {
    describe('Artikel Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ArtikelService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/artikels';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Artikel', () => {
                service.create(new Artikel(null)).subscribe(received => {
            ...
            it('should update a Artikel', () => {
                service.update(new Artikel(123)).subscribe(received => {
