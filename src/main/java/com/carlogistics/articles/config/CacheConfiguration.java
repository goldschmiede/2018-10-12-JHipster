package com.carlogistics.articles.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.carlogistics.articles.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.carlogistics.articles.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
